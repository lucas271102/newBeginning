...
<footer className="bg-gradient-to-r from-slate-900 to-slate-800 shadow-xl">
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-md">
      ...
      <form className="mt-6">
        <div className="relative max-w-lg">
          ...
          <input
            className="w-full rounded-full border-gray-200 bg-gray-100 text-white p-4 pe-32 text-sm font-medium"
            id="email"
            type="email"
          ...
          <button
            className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-slate-800 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700"
          >
            Subscribe
          </button>
        </div>
    ...
    <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
      <div className="mx-auto max-w-sm lg:max-w-none">
        <p className="mt-4 text-center text-white font-sans lg:text-left lg:text-lg">
         Created and owned by Lucas Speziale
        </p>
      ...
      <div className="grid grid-cols-1 gap-8 text-center  lg:grid-cols-3 lg:text-left">
        <div>
          ...
          <ul className="mt-6 space-y-1">
            <li>
              <a className="text-gray-700 transition hover:text-white" href="#"> Marketing </a>
            </li>
