...
const Home = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    <div className="mx-auto max-w-lg text-center">
      <h2 className="text-3xl font-extralight sm:text-4xl  ">Boost your online presence</h2>
    ...
    <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-1 ">
      ...
      >
        ...
        <h2 className="mt-4 text-xl font-bold text-white">Digital solutions for professionals</h2>

        <p className="mt-1 text-sm text-gray-300">
          Increase your online engagement, multiply your potential customers
        </p>
      </a>
